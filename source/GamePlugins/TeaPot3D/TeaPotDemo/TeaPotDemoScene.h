...
// using Render3DObjectLayer.  No 2-D background is shown — the 3D layer clears to a
...
public:
    ...
    TeaPotDemoScene(Renderer2D* Renderer, SDL_Window* Window);
...
private:
    ...
    // immediately applies it to Render3DObjectLayer.
